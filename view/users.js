function getUsers() {
    ...
    xmlUsers.open("GET", "http://127.0.0.1/io_exb/controller/get_users.php");
  ...
  function getUser() {
    ...
    xmlUsers.open("GET", "http://127.0.0.1/io_exb/controller/get_user.php?id="+id);
  ...
  function addUser() {
    var url =
      'http://127.0.0.1/io_exb/controller/add_user.php';
    // var url =
  ...
  function updateUser() {
    var url =
      'http://127.0.0.1/io_exb/controller/update_user.php';
    // var url =
  ...
  function deleteUser() {
    ...
    xmlUsers.open("GET", "http://127.0.0.1/io_exb/controller/delete_user.php?id="+id);
